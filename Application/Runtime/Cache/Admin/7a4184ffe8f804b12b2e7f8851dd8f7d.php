        ...
        <form id="add_form" name="add_form" method="post" enctype="multipart/form-data">
            <table class="info_table" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    <th>撰写作者：</th>
                    <td>
                        <select name='article[member_id]' id="member_id" class="selecter" required>
                        </select>
                    </td>
        ...
        <form id="edit_form" name="edit_form" method="post" enctype="multipart/form-data">
            ...
            <table class="info_table" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    <th>撰写作者：</th>
                    <td>
                        <select name='article[member_id]' id="member_id_edit" class="selecter" required>
                        </select>
                    </td>
                    <th width="100">文章类别：</th>
                    <td>
                ...
                <tr>
                    <th>文章内容：</th>
                    <td colspan="3">
                        <script id="editor_edit" type="text/plain" style="width:800px;height:200px;"></script>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align: center;">
