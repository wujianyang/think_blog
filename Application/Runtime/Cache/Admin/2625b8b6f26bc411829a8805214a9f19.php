...
<head>
    <title>相册管理_<?php echo (C("TITLE")); ?></title>
    ...
    <script language="JavaScript" src="<?php echo (C("JS")); ?>admin/photoAdmin.js"></script>
        ...
        <div class="toolbar">
            ...
            <div class="rfloat">
                <select id="keyItem">
                    ...
                    <option value="photo_title+like">相册标题</option>
        ...
        <div class="list_table_div mar_t20">
            <table class="list_table" cellspacing="1" cellpadding="0">
                ...
                <?php if(is_array($data["rows"])): $i = 0; $__LIST__ = array_slice($data["rows"],0,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rows): $mod = ($i % 2 );++$i;?><tr class="tr_line">
                        ...
                        <td width="200"><a class="info" href="javascript:void(0);" value="<?php echo ($rows["id"]); ?>"><?php echo ($rows["photo_title"]); ?></a></td>
