...
<head>
    <meta charset="UTF-8">
    <title>后台管理登录_<?php echo (C("TITLE")); ?></title>
    ...
    <script type="text/javascript">
        function getVerify() {
            $('.vImg').attr('src',"<?php echo U('Admin/getVerify');?>");
        }
...
<div id="login">
    ...
    <form id="login_form" name="login_form" method="post" action="<?php echo U('Admin/login');?>">
        ...
        <img src="<?php echo U('Admin/getVerify');?>" class="vImg" onclick="getVerify()" title="点击更换验证码" />
