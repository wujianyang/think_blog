...
<head>
    <meta charset="UTF-8">
    <title>我的相册_<?php echo (C("TITLE")); ?></title>
    ...
    <script src="<?php echo (C("JS")); ?>home/personPhoto.js"></script>
</head>
<body>
    ...
    <div id="list_div">
        <div class="toolbar">
            ...
            <div class="rfloat">
                <select id="keyItem">
                    ...
                    <option value="photo_title+like">相册分类</option>
                </select>
        ...
        <div class="list_table_div mar_t20">
            <table class="list_table" cellspacing="1" cellpadding="0">
                ...
                <?php if(is_array($photo)): $i = 0; $__LIST__ = array_slice($photo,0,10,true);if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$photo): $mod = ($i % 2 );++$i;?><tr class="tr_line">
                        <td width="50"><input type="checkbox" class="id" name="id[]" value="<?php echo ($photo["photo_id"]); ?>" /></td>
                        <td width="50"><?php echo ($photo["photo_id"]); ?></td>
                        <td width="200"><a class="info" href="javascript:void(0);" value="<?php echo ($photo["photo_id"]); ?>"><?php echo ($photo["photo_title"]); ?></a></td>
                        <td width="100"><a href="<?php echo U('Member/personPhotoImg',array('photo_id'=>$photo['photo_id']));?>"><?php echo ($photo["photo_count"]); ?></a></td>
