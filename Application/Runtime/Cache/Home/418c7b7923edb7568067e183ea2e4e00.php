    ...
    <div id="list_div">
        ...
        <div class="list_table_div mar_t20">
            ...
            <table class="list_table" id="" cellspacing="1" cellpadding="0">
                ...
                <?php if(is_array($articleComment)): $i = 0; $__LIST__ = array_slice($articleComment,0,10,true);if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$articleComment): $mod = ($i % 2 );++$i;?><tr class="tr_line">
                        <td><input type="checkbox" class="id" name="id[]" value="<?php echo ($articleComment["article_comment_id"]); ?>" /></td>
                        <td width="50"><?php echo ($articleComment["article_comment_id"]); ?></td>
                        <td width="100"><?php echo ($articleComment["member_id"]); ?></td>
                        <td width="150"><?php echo ($articleComment["member_name"]); ?></td>
                        <td width="580"><?php echo ($articleComment["comment_content"]); ?></td>
                        <td width="150"><?php echo ($articleComment["comment_time"]); ?></td>
