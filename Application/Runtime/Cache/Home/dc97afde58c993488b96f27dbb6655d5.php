...
<div class="main_form">
    <div id="list_div">
        ...
        <div class="list_table_div mar_t20" id="list_table_div">
            <?php if(is_array($photoImg)): $i = 0; $__LIST__ = array_slice($photoImg,0,10,true);if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$photoImg): $mod = ($i % 2 );++$i;?><div class="photo_div">
                    <input type="hidden"  class="id" name="id[]" value="<?php echo ($photoImg["id"]); ?>" />
                    <div class="img_div">
                        <img src="<?php echo (C("UPLOAD")); echo ($photoImg["img_src"]); ?>" width="200" height="150" />
                    </div>
                    <p>ID：<a class="info" href="javascript:void(0);" value="<?php echo ($photoImg["id"]); ?>"><?php echo ($photoImg["id"]); ?> | <?php echo ($photoImg["img_title"]); ?></a></p>
