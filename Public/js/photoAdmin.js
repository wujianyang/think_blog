$(document).ready(function(){
    ...
    $('#del').click(function(){
        ...
        if(arr.length==0){
            ...
            if(confirm('该相册的相关相片也会一起删除,确定删除？')){
                ...
                $.ajax({
                    url:"/think_blog/index.php/Admin/Photo/del",
                    type:"post",
                    dataType:"json",
                    data:{id:arr},
    ...
    $('#add_form').validate({
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                url:"/think_blog/index.php/Admin/Photo/add",
                type:"post",
                data:{"act":"add"},
                dataType:"json",
                success:function(data){
    ...
    $('#edit_form').validate({
        ...
        submitHandler:function(form){
            $(form).ajaxSubmit({
                url:"/think_blog/index.php/Admin/Photo/edit",
                type:"post",
                data:{"act":"edit"},
                dataType:"json",
                success:function(data){
    ...
    $('.info').live('click', function(){
        ...
        if(/\d/.test(id)){
            ...
            //根据id信息
            $.ajax({
                url:"/think_blog/index.php/Admin/Photo/info",
                type:"post",
                data:{"id":id},
                dataType:"json",
...
function showList(page,page_size,keyItem,key,com){
    ...
    $.ajax({
        url:"/think_blog/index.php/Admin/Photo/index",
        type:"post",
